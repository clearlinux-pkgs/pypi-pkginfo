...
Source0  : https://files.pythonhosted.org/packages/12/d1/03b865975864a30d4a23f87fd5b9f816db2e4b2e8f4fe696a3238b749cc0/pkginfo-1.9.2.tar.gz
...
%prep
%setup -q -n pkginfo-1.9.2
cd %{_builddir}/pkginfo-1.9.2
pushd ..
cp -a pkginfo-1.9.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669823407
