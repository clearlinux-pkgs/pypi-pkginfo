...
Source0  : https://files.pythonhosted.org/packages/2f/72/347ec5be4adc85c182ed2823d8d1c7b51e13b9a6b0c1aae59582eca652df/pkginfo-1.10.0.tar.gz
...
%prep
%setup -q -n pkginfo-1.10.0
cd %{_builddir}/pkginfo-1.10.0
pushd ..
cp -a pkginfo-1.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709491656
