...
Source0  : https://files.pythonhosted.org/packages/24/03/e26bf3d6453b7fda5bd2b84029a426553bb373d6277ef6b5ac8863421f87/pkginfo-1.12.1.2.tar.gz
...
%prep
%setup -q -n pkginfo-1.12.1.2
cd %{_builddir}/pkginfo-1.12.1.2
pushd ..
cp -a pkginfo-1.12.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739986948
